...
void memoryInitialize_gecko(void)
{
...
//! wraps
//!-------------------------------------------------------------------------------------------
void *__wrap_malloc_gecko(size_t size)
{
    // pointer to a function resolve
	return ((void * (*)(size_t))(*pMEMAllocFromDefaultHeap))(size);
}

void *__wrap_memalign_gecko(size_t align, size_t size)
{
    if (align < 4)
        align = 4;
...
void *__wrap_calloc_gecko(size_t n, size_t size)
{
    void *p = __wrap_malloc_gecko(n * size);
	if (p != 0) {
		memset(p, 0, n * size);
	}
	return p;
...
size_t __wrap_malloc_usable_size_gecko(void *p)
{
    //! TODO: this is totally wrong and needs to be addressed
	return 0x7FFFFFFF;
}

void *__wrap_realloc_gecko(void *p, size_t size)
{
    void *new_ptr = __wrap_malloc_gecko(size);
	if (new_ptr != 0)
	{
		memcpy(new_ptr, p, __wrap_malloc_usable_size_gecko(p) < size ? __wrap_malloc_usable_size_gecko(p) : size);
		__wrap_free_gecko(p);
	}
	return new_ptr;
}
...
//! reent versions
//!-------------------------------------------------------------------------------------------
void *__wrap__malloc_r_gecko(struct _reent *r, size_t size)
{
	return __wrap_malloc_gecko(size);
}

void *__wrap__calloc_r_gecko(struct _reent *r, size_t n, size_t size)
{
    return __wrap_calloc_gecko(n, size);
}

void *__wrap__memalign_r_gecko(struct _reent *r, size_t align, size_t size)
{
    return __wrap_memalign_gecko(align, size);
}

void __wrap__free_r_gecko(struct _reent *r, void *p)
{
    __wrap_free_gecko(p);
}

size_t __wrap__malloc_usable_size_r_gecko(struct _reent *r, void *p)
{
    return __wrap_malloc_usable_size_gecko(p);
}

void *__wrap__realloc_r_gecko(struct _reent *r, void *p, size_t size)
{
    return __wrap_realloc_gecko(p, size);
}

//!-------------------------------------------------------------------------------------------
//! some wrappers
//!-------------------------------------------------------------------------------------------
void * MEM2_alloc_gecko(unsigned int size, unsigned int align)
{
    return __wrap_memalign_gecko(align, size);
}

void MEM2_free_gecko(void *ptr)
{
    __wrap_free_gecko(ptr);
}

void * MEM1_alloc_gecko(unsigned int size, unsigned int align)
{
    if (align < 4)
        align = 4;
...
void MEM1_free_gecko(void *ptr)
{
    MEMFreeToExpHeap(mem1_heap, ptr);
}

void * MEMBucket_alloc_gecko(unsigned int size, unsigned int align)
{
    if (align < 4)
        align = 4;
...
void MEMBucket_free_gecko(void *ptr)
{
